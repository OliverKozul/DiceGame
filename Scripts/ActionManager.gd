...
func attack_player_button_pressed(player_id: int) -> void:
	player_ui.show_combat_ui(player_id, Enums.Target.PLAYER)
...
func attack_mobs_button_pressed(player_id: int) -> void:
	player_ui.show_combat_ui(player_id, Enums.Target.MOB)
...
func attack_boss_button_pressed(player_id: int) -> void:
	player_ui.show_combat_ui(player_id, Enums.Target.BOSS)
...
func shop_button_pressed(player_id: int) -> void:
	player_ui.show_combat_ui(player_id, Enums.Target.NONE)
